...
## Model
The model is available in [HuggingFace](https://huggingface.co/a-b-c-x-y-z/Manga-Text-Segmentation-2025). The Model has a Unet++ architecture with an EfficientNetv2 backbone. 
